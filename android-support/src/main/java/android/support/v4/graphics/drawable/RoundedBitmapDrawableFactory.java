...
public final class RoundedBitmapDrawableFactory {
     ...
     */
    @NonNull
    public static android.support.v4.graphics.drawable.RoundedBitmapDrawable create(@NonNull Resources res, @Nullable Bitmap bitmap) {
     ...
     */
    @NonNull
    public static android.support.v4.graphics.drawable.RoundedBitmapDrawable create(@NonNull Resources res, @NonNull String filepath) {
     ...
     */
    @NonNull
    public static android.support.v4.graphics.drawable.RoundedBitmapDrawable create(@NonNull Resources res, @NonNull InputStream is) {
